...
template bool is_prefix<char>(const std::basic_string<char>& w, const char& v);
template bool is_prefix<wchar_t>(const std::basic_string<wchar_t>& w, const wchar_t& v);
...
template bool is_true_prefix<char>(const std::basic_string<char>& w, const char& v);
template bool is_true_prefix<wchar_t>(const std::basic_string<wchar_t>& w, const wchar_t& v);
