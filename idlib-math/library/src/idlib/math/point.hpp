...
struct random_functor<point<V>, void>
{
    ...
    { return point_type(random<typename point_type::implementation_type>()); }
    
    point_type operator()(rng *rng) const
    { return point_type(random<typename point_type::implementation_type>(rng)); }

    point_type operator()(const interval<scalar_type>& interval) const
    { return point_type(random<typename point_type::implementation_type>(interval)); }
    
    point_type operator()(rng *rng, const interval<scalar_type>& interval) const
    { return point_type(random<typename point_type::implementation_type>(rng, interval)); }
