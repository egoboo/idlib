...
struct document_utilities
{
    ...
    static const std::function<void(const idlib::text_inserted_event&)> INSERTED;
    static const std::function<void(const idlib::text_replaced_event&)> REPLACED;
    static const std::function<void(const idlib::text_erased_event&)> ERASED;
    static const std::function<void(const idlib::text_set_event&)> SET;

    std::vector<idlib::connection> m_connections;

    void connect(int r, idlib::document& d)
    {
