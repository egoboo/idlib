...
/// @file idlib/hll/qualified_name.hpp
...
static_assert(std::is_copy_constructible<qualified_name>::value, "idlib::hll::qualified_name must be copy constructible");
static_assert(std::is_move_constructible<qualified_name>::value, "idlib::hll::qualified_name must be move constructible");
static_assert(std::is_copy_assignable<qualified_name>::value, "idlib::hll::qualified_name must be copy assignable");
static_assert(std::is_move_assignable<qualified_name>::value, "idlib::hll::qualified_name must be move assignable");
...
template <>
struct hash<idlib::hll::qualified_name>
{
    size_t operator()(const idlib::hll::qualified_name& x) const;
};

template <>
struct equal_to<idlib::hll::qualified_name>
{
    bool operator()(const idlib::hll::qualified_name& x, const idlib::hll::qualified_name& y) const;
};

template <>
struct less<idlib::hll::qualified_name>
{
    bool operator()(const idlib::hll::qualified_name& x, const idlib::hll::qualified_name& y) const;
};
