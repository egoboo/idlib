#include "idlib/document/document.hpp"

#include "idlib/document/text_erased_event.hpp"
#include "idlib/document/text_inserted_event.hpp"
#include "idlib/document/text_replaced_event.hpp"
#include "idlib/document/text_set_event.hpp"
...
void document::erase(size_t index)
{
    ...
    {
        throw argument_out_of_bounds_error(__FILE__, __LINE__, "index");
    }
...
void document::erase(size_t index, size_t length)
{
    ...
    {
        throw argument_out_of_bounds_error(__FILE__, __LINE__, "index + length");
    }
    if (length == 0) return;
    auto old_text = m_text;
...
void document::insert_text(const std::string& text, size_t index)
{
    if (index > m_text.size())
    {
        ...
        throw idlib::argument_out_of_bounds_error(__FILE__, __LINE__, "index");
    }
    if (text.empty())
    {
