...
/// @brief Specialization of idlib::c::decoder for decoding <c>natural</c> literals to <c>unsigned long</c> values.
template <>
...
/// @brief Specialization of idlib::c::decoder for decoding <c>natural</c> literals to <c>unsigned long long</c> values.
template <>
...
/// @brief Specialization of idlib::decoder for decoding <c>natural</c> literals to <c>unsigned char</c> values.
template <>
...
/// @brief Specialization of idlib::decoder for decoding <c>natural</c> literals to <c>unsigned short</c> values.
template <>
...
/// @brief Specialization of idlib::decoder for decoding <c>natural</c> literals to <c>unsigned int</c> values.
template <>
